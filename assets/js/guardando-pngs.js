...
/**
 * Created by estevandefaz on 3/11/16.
 */
...
tiemposcambian.GuardandoPNGs = (function () {
    ...
    function init() {
        ...
        ctx.lineJoin = "round";
        // button events
        document.getElementById('bt-save').onmouseup = genera_tabla;
   ...
   //var data = canvas.toDataURL('image/png');
        ...
        xhr.open('POST','http://localhost:9999/Cliente/rest/data/cargar',true);
        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        xhr.send('c=Categoria'+'&p='+rgba+categoria.value); 
    }
